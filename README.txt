...
a persistence unit "Student1318434PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Student1318434/pom.xml":
...
artifacts ("Student1318434-ejb.jar" and "Student1318434-web.war") are already built. You can build
